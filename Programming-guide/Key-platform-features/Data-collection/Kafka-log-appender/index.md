...
* [Creating Kafka log appender in Admin UI](#creating-kafka-log-appender-in-admin-ui)
* [Creating Kafka log appender with REST API](#creating-kafka-log-appender-with-rest-api)
  * [Configuration](#configuration)
  * [Fields description](#fields-description)
  * [Administration](#administration)
* [Playing with Kafka log appender](#playing-with-kafka-log-appender)
...
It is also possible to create a Kafka log appender for your application by using REST API. The following example illustrates how to provision 
the Kafka log appender for the Cell Monitor demo application available in Kaa Sandbox.
