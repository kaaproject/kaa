  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProfileSyncRequest>
    ...
    private Builder(org.kaaproject.kaa.common.endpoint.gen.ProfileSyncRequest.Builder other) {
      ...
      if (isValidValue(fields()[3], other.endpointAccessToken)) {
        this.endpointAccessToken = data().deepCopy(fields()[3].schema(), other.endpointAccessToken);
