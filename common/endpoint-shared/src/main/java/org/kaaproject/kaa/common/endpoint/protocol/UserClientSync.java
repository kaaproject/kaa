...
public class UserClientSync {
   private org.kaaproject.kaa.common.endpoint.protocol.UserAttachRequest userAttachRequest;
   private java.util.List<org.kaaproject.kaa.common.endpoint.protocol.EndpointAttachRequest> endpointAttachRequests;
   private java.util.List<org.kaaproject.kaa.common.endpoint.protocol.EndpointDetachRequest> endpointDetachRequests;
   ...
   */
  public UserClientSync(org.kaaproject.kaa.common.endpoint.protocol.UserAttachRequest userAttachRequest, java.util.List<org.kaaproject.kaa.common.endpoint.protocol.EndpointAttachRequest> endpointAttachRequests, java.util.List<org.kaaproject.kaa.common.endpoint.protocol.EndpointDetachRequest> endpointDetachRequests) {
   ...
   */
  public org.kaaproject.kaa.common.endpoint.protocol.UserAttachRequest getUserAttachRequest() {
   ...
   */
  public void setUserAttachRequest(org.kaaproject.kaa.common.endpoint.protocol.UserAttachRequest value) {
   ...
   */
  public java.util.List<org.kaaproject.kaa.common.endpoint.protocol.EndpointAttachRequest> getEndpointAttachRequests() {
   ...
   * @param value the value to set.
   */
  public void setEndpointAttachRequests(java.util.List<org.kaaproject.kaa.common.endpoint.protocol.EndpointAttachRequest> value) {
   ...
   */
  public java.util.List<org.kaaproject.kaa.common.endpoint.protocol.EndpointDetachRequest> getEndpointDetachRequests() {
   ...
   * @param value the value to set.
   */
  public void setEndpointDetachRequests(java.util.List<org.kaaproject.kaa.common.endpoint.protocol.EndpointDetachRequest> value) {
