...
public class NotificationSyncResponse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public NotificationSyncResponse(java.lang.Integer appStateSeqNumber, org.kaaproject.kaa.common.endpoint.gen.SyncResponseStatus responseStatus, java.util.List<org.kaaproject.kaa.common.endpoint.gen.Notification> notifications, java.util.List<org.kaaproject.kaa.common.endpoint.gen.Topic> availableTopics) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: notifications = (java.util.List<org.kaaproject.kaa.common.endpoint.gen.Notification>)value$; break;
    case 3: availableTopics = (java.util.List<org.kaaproject.kaa.common.endpoint.gen.Topic>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NotificationSyncResponse>
    ...
    private Builder(org.kaaproject.kaa.common.endpoint.gen.NotificationSyncResponse.Builder other) {
      ...
      if (isValidValue(fields()[3], other.availableTopics)) {
        this.availableTopics = data().deepCopy(fields()[3].schema(), other.availableTopics);
    ...
    /** Sets the value of the 'appStateSeqNumber' field */
    public org.kaaproject.kaa.common.endpoint.gen.NotificationSyncResponse.Builder setAppStateSeqNumber(int value) {
    ...
    public org.kaaproject.kaa.common.endpoint.gen.NotificationSyncResponse.Builder clearAppStateSeqNumber() {
    ...
    public NotificationSyncResponse build() {
      try {
        ...
        record.notifications = fieldSetFlags()[2] ? this.notifications : (java.util.List<org.kaaproject.kaa.common.endpoint.gen.Notification>) defaultValue(fields()[2]);
        record.availableTopics = fieldSetFlags()[3] ? this.availableTopics : (java.util.List<org.kaaproject.kaa.common.endpoint.gen.Topic>) defaultValue(fields()[3]);
        return record;
      } catch (Exception e) {
