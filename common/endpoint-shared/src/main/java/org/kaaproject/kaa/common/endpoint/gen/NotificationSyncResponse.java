...
public class NotificationSyncResponse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public NotificationSyncResponse(java.util.List<org.kaaproject.kaa.common.endpoint.gen.Notification> notifications, java.util.List<org.kaaproject.kaa.common.endpoint.gen.Topic> availableTopics) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: notifications = (java.util.List<org.kaaproject.kaa.common.endpoint.gen.Notification>)value$; break;
    case 1: availableTopics = (java.util.List<org.kaaproject.kaa.common.endpoint.gen.Topic>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NotificationSyncResponse>
    ...
    private Builder(org.kaaproject.kaa.common.endpoint.gen.NotificationSyncResponse.Builder other) {
      ...
      if (isValidValue(fields()[1], other.availableTopics)) {
        this.availableTopics = data().deepCopy(fields()[1].schema(), other.availableTopics);
    ...
    public NotificationSyncResponse build() {
      try {
        ...
        record.notifications = fieldSetFlags()[0] ? this.notifications : (java.util.List<org.kaaproject.kaa.common.endpoint.gen.Notification>) defaultValue(fields()[0]);
        record.availableTopics = fieldSetFlags()[1] ? this.availableTopics : (java.util.List<org.kaaproject.kaa.common.endpoint.gen.Topic>) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
