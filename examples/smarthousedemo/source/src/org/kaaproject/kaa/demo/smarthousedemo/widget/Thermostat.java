...
public class Thermostat extends View {
	...
	private void init(Context context, AttributeSet attrs, int defStyle) {
		...
		mCoolingText = getResources().getText(R.string.cooling_thermostat_msg);
		mHeatingText = getResources().getText(R.string.heating_thermostat_msg);
		...
		Typeface tf = FontCache.get(context, "Rajdhani-Bold.ttf");
    ...
    private static int evaluateColor(float fraction, int startInt, int endInt) {
