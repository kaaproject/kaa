...
static void kaa_configuration_traffic_lights_configuration_destroy(void *data)
{
    if (data) {
        kaa_configuration_traffic_lights_configuration_t *record = (kaa_configuration_traffic_lights_configuration_t *)data;
...
static void kaa_configuration_traffic_lights_configuration_serialize(avro_writer_t writer, void *data)
{
    if (data) {
        kaa_configuration_traffic_lights_configuration_t *record = (kaa_configuration_traffic_lights_configuration_t *)data;

        kaa_enum_serialize(writer, &record->main_road_state);
        record->__uuid->serialize(writer, record->__uuid);
    }
}

static size_t kaa_configuration_traffic_lights_configuration_get_size(void *data)
{
    if (data) {
        size_t record_size = 0;
        kaa_configuration_traffic_lights_configuration_t *record = (kaa_configuration_traffic_lights_configuration_t *)data;

        record_size += kaa_enum_get_size(&record->main_road_state);
...
{
    kaa_configuration_traffic_lights_configuration_t *record = 
            (kaa_configuration_traffic_lights_configuration_t *)KAA_CALLOC(1, sizeof(kaa_configuration_traffic_lights_configuration_t));

    if (record) {
        record->serialize = kaa_configuration_traffic_lights_configuration_serialize;
        record->get_size = kaa_configuration_traffic_lights_configuration_get_size;
        record->destroy = kaa_configuration_traffic_lights_configuration_destroy;
    }
...
{
    kaa_configuration_traffic_lights_configuration_t *record = 
            (kaa_configuration_traffic_lights_configuration_t *)KAA_MALLOC(sizeof(kaa_configuration_traffic_lights_configuration_t));
    ...
    if (record) {
        ...
        int64_t main_road_state_value;
        avro_binary_encoding.read_long(reader, &main_road_state_value);
        record->main_road_state = main_road_state_value;
