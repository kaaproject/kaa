...
import org.kaaproject.kaa.demo.iotworld.smarthome.fragment.list.adapter.LightningDeviceListAdapter;
...
public class LightningDeviceListFragment extends AbstractDeviceListFragment<LightningDevice> {
    ...
    @Override
    protected AbstractDeviceListAdapter<LightningDevice> createListAdapter(RecyclerView recyclerView) {
        return new LightningDeviceListAdapter(recyclerView, mDeviceStore, this);
    }
