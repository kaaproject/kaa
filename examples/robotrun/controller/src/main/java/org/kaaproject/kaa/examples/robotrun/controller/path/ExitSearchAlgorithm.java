...
public interface ExitSearchAlgorithm {
    
    Cell getNextCell(Labyrinth labyrinth, Cell current, Map<String, RobotPosition> other);

    void onRobotLocationChanged(String key, Cell cell);
