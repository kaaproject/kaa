...
public interface ConfigurationManager extends ConfigurationReceiver {
    ...
    boolean addListener(LabyrinthUpdateListener listener);
    boolean removeListener(LabyrinthUpdateListener listener);
}
