 ...
 */
typedef void (* on_kaa_device_event_class_family_device_info_request)(void *context, kaa_device_event_class_family_device_info_request_t *event, kaa_endpoint_id_p source);

/**
 * @brief Listener of device_info_response events.
 */
typedef void (* on_kaa_device_event_class_family_device_info_response)(void *context, kaa_device_event_class_family_device_info_response_t *event, kaa_endpoint_id_p source);
