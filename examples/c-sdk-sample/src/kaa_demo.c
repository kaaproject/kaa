...
#define KAA_ADD_LOG_FREQUENCY    3  // sec
...
void kaa_demo_check_ping(struct timeval *timer_start)
{
...
int kaa_demo_event_loop()
{
    ...
    while (!is_shutdown) {
        ...
        struct timeval select_timeout = { KAA_ADD_LOG_FREQUENCY, 0 };
        ...
        if (select_result == 0) {
            ...
            kaa_demo_check_ping(&timer_start);
