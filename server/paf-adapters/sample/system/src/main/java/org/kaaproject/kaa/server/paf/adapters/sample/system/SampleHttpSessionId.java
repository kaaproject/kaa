...
public class SampleHttpSessionId implements SessionId {

    private final String httpSessionId;
    
    public SampleHttpSessionId(String httpSessionId) {
        super();
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        SampleHttpSessionId other = (SampleHttpSessionId) obj;
    ...
    public String toString() {
        return "SampleHttpSessionId [httpSessionId=" + httpSessionId + "]";
    }
