...
/**
 * BootstrapInitializationService Interface.
 * Used to initialize and run BootstrapService.
 *
 * @author Andrey Panasenko
 */
public interface BootstrapInitializationService {

    /**
     * Start BootstrapService.
     */
    void start();

    /**
     * Stop BootstrapService.
     */
    void stop();
