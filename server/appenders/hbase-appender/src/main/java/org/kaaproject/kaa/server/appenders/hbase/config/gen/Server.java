...
public class Server extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Server(java.lang.CharSequence zk_Quorum, java.lang.CharSequence port) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: zk_Quorum = (java.lang.CharSequence)value$; break;
  ...
  /**
   * Gets the value of the 'zk_Quorum' field.
   */
  ...
  /**
   * Sets the value of the 'zk_Quorum' field.
   * @param value the value to set.
   */
  public void setZkQuorum(java.lang.CharSequence value) {
    this.zk_Quorum = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Server>
    ...
    private java.lang.CharSequence zk_Quorum;
    ...
    private Builder(org.kaaproject.kaa.server.appenders.hbase.config.gen.Server.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.zk_Quorum)) {
        this.zk_Quorum = data().deepCopy(fields()[0].schema(), other.zk_Quorum);
    ...
    /** Checks whether the 'zk_Quorum' field has been set */
    public boolean hasZkQuorum() {
      return fieldSetFlags()[0];
    }
    
    /** Clears the value of the 'zk_Quorum' field */
    ...
    public Server build() {
      try {
        ...
        record.zk_Quorum = fieldSetFlags()[0] ? this.zk_Quorum : (java.lang.CharSequence) defaultValue(fields()[0]);
