...
public class CdapConfig extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CdapConfig\",\"namespace\":\"org.kaaproject.kaa.server.appenders.cdap.config\",\"fields\":[{\"name\":\"stream\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"stream\",\"displayName\":\"Stream\"},{\"name\":\"host\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"localhost\",\"displayName\":\"Host\"},{\"name\":\"port\",\"type\":\"int\",\"default\":10000,\"displayName\":\"Port\"},{\"name\":\"ssl\",\"type\":[\"boolean\",\"null\"],\"displayName\":\"Use SSL\",\"optional\":true},{\"name\":\"verifySslCert\",\"type\":[\"boolean\",\"null\"],\"displayName\":\"Validate SSL Certificate\",\"optional\":true},{\"name\":\"writerPoolSize\",\"type\":[\"int\",\"null\"],\"displayName\":\"Writer thread/connection pool size\",\"optional\":true},{\"name\":\"callbackThreadPoolSize\",\"type\":[\"int\",\"null\"],\"default\":2,\"displayName\":\"Callback thread pool size\",\"optional\":true},{\"name\":\"version\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"},\"null\"],\"displayName\":\"Version\",\"optional\":true},{\"name\":\"authClient\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"},\"null\"],\"displayName\":\"Authentication client class name\",\"optional\":true},{\"name\":\"username\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"},\"null\"],\"displayName\":\"Username\",\"optional\":true},{\"name\":\"password\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"},\"null\"],\"displayName\":\"Password\",\"optional\":true}]}");
  ...
  public static org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder newBuilder() {
    return new org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder();
  }
  
  /** Creates a new CdapConfig RecordBuilder by copying an existing Builder */
  public static org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder newBuilder(org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder other) {
    return new org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder(other);
  }
  
  /** Creates a new CdapConfig RecordBuilder by copying an existing CdapConfig instance */
  public static org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder newBuilder(org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig other) {
    return new org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CdapConfig>
    ...
    private Builder() {
      super(org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder other) {
      super(other);
    ...
    private Builder(org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig other) {
            super(org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.SCHEMA$);
      if (isValidValue(fields()[0], other.stream)) {
        this.stream = data().deepCopy(fields()[0].schema(), other.stream);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'stream' field */
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder setStream(java.lang.String value) {
    ...
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder clearStream() {
      stream = null;
    ...
    /** Sets the value of the 'host' field */
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder setHost(java.lang.String value) {
    ...
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder clearHost() {
      host = null;
    ...
    /** Sets the value of the 'port' field */
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder setPort(int value) {
    ...
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder clearPort() {
    ...
    /** Sets the value of the 'ssl' field */
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder setSsl(java.lang.Boolean value) {
    ...
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder clearSsl() {
      ssl = null;
    ...
    /** Sets the value of the 'verifySslCert' field */
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder setVerifySslCert(java.lang.Boolean value) {
    ...
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder clearVerifySslCert() {
      verifySslCert = null;
    ...
    /** Sets the value of the 'writerPoolSize' field */
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder setWriterPoolSize(java.lang.Integer value) {
    ...
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder clearWriterPoolSize() {
      writerPoolSize = null;
    ...
    /** Sets the value of the 'callbackThreadPoolSize' field */
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder setCallbackThreadPoolSize(java.lang.Integer value) {
    ...
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder clearCallbackThreadPoolSize() {
    ...
    /** Sets the value of the 'version' field */
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder setVersion(java.lang.String value) {
    ...
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder clearVersion() {
      version = null;
    ...
    /** Sets the value of the 'authClient' field */
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder setAuthClient(java.lang.String value) {
    ...
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder clearAuthClient() {
      authClient = null;
    ...
    /** Sets the value of the 'username' field */
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder setUsername(java.lang.String value) {
    ...
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder clearUsername() {
      username = null;
    ...
    /** Sets the value of the 'password' field */
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder setPassword(java.lang.String value) {
    ...
    public org.kaaproject.kaa.server.appenders.cdap.config.CdapConfig.Builder clearPassword() {
      password = null;
