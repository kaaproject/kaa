...
public class FileConfig extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"FileConfig\",\"namespace\":\"org.kaaproject.kaa.server.appenders.file.config\",\"fields\":[{\"name\":\"publicKey\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\",\"displayName\":\"Public Key\",\"maxLength\":1000},{\"name\":\"logsRootPath\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"/kaa_log_uploads\",\"displayName\":\"Logs root path\"},{\"name\":\"rollingFileNamePatern\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"logFile.%d{yyyy-MM-dd}.log\",\"displayName\":\"Rolling file name pattern\"},{\"name\":\"rollingMaxHistory\",\"type\":\"int\",\"default\":30,\"displayName\":\"Rolling max history\"},{\"name\":\"triggerMaxFileSize\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"1GB\",\"displayName\":\"Trigger max file size\"},{\"name\":\"encoderPattern\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"%-4relative [%thread] %-5level %logger{35} - %msg%n\",\"displayName\":\"Encoder pattern\"}]}");
  ...
  public static org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder newBuilder() {
    return new org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder();
  }
  
  /** Creates a new FileConfig RecordBuilder by copying an existing Builder */
  public static org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder newBuilder(org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder other) {
    return new org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder(other);
  }
  
  /** Creates a new FileConfig RecordBuilder by copying an existing FileConfig instance */
  public static org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder newBuilder(org.kaaproject.kaa.server.appenders.file.config.FileConfig other) {
    return new org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FileConfig>
    ...
    private Builder() {
      super(org.kaaproject.kaa.server.appenders.file.config.FileConfig.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder other) {
      super(other);
    ...
    private Builder(org.kaaproject.kaa.server.appenders.file.config.FileConfig other) {
            super(org.kaaproject.kaa.server.appenders.file.config.FileConfig.SCHEMA$);
      if (isValidValue(fields()[0], other.publicKey)) {
        this.publicKey = data().deepCopy(fields()[0].schema(), other.publicKey);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'publicKey' field */
    public org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder setPublicKey(java.lang.String value) {
    ...
    public org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder clearPublicKey() {
      publicKey = null;
    ...
    /** Sets the value of the 'logsRootPath' field */
    public org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder setLogsRootPath(java.lang.String value) {
    ...
    public org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder clearLogsRootPath() {
      logsRootPath = null;
    ...
    /** Sets the value of the 'rollingFileNamePatern' field */
    public org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder setRollingFileNamePatern(java.lang.String value) {
    ...
    public org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder clearRollingFileNamePatern() {
    ...
    /** Sets the value of the 'rollingMaxHistory' field */
    public org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder setRollingMaxHistory(int value) {
    ...
    public org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder clearRollingMaxHistory() {
    ...
    /** Sets the value of the 'triggerMaxFileSize' field */
    public org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder setTriggerMaxFileSize(java.lang.String value) {
    ...
    public org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder clearTriggerMaxFileSize() {
    ...
    /** Sets the value of the 'encoderPattern' field */
    public org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder setEncoderPattern(java.lang.String value) {
    ...
    public org.kaaproject.kaa.server.appenders.file.config.FileConfig.Builder clearEncoderPattern() {
      encoderPattern = null;
