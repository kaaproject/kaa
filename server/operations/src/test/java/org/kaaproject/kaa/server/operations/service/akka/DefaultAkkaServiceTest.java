...
public class DefaultAkkaServiceTest {
    ...
    private SessionInitRequest toSignedRequest(final UUID uuid, final ChannelType channelType, final ChannelHandlerContext ctx, SyncRequest request,
            final ResponseBuilder responseBuilder, final ErrorBuilder errorBuilder) throws Exception {
    ...
    private SessionInitRequest toSignedRequest(final UUID uuid, final ChannelType channelType, final ChannelHandlerContext ctx, SyncRequest request,
            final ResponseBuilder responseBuilder, final ErrorBuilder errorBuilder, MessageEncoderDecoder crypt) throws Exception {
    ...
    public void testLongSyncRequest() throws Exception {
        ...
        Mockito.when(cacheService.getEndpointKey(EndpointObjectHash.fromBytes(clientPublicKeyHash.array()))).thenReturn(clientPair.getPublic());
        Mockito.when(operationsService.sync(Mockito.any(SyncRequest.class), Mockito.any(EndpointProfileDto.class))).thenReturn(noDeltaResponse);
    ...
    public void testLongSyncNotification() throws Exception {
        ...
        Mockito.when(operationsService.sync(Mockito.any(SyncRequest.class), Mockito.any(EndpointProfileDto.class))).thenReturn(deltaResponse);
    ...
    public void testLongSyncUnicastNotification() throws Exception {
        ...
        Mockito.when(operationsService.updateSyncResponse(noDeltaResponse.getResponse(), new ArrayList<NotificationDto>(), UNICAST_NOTIFICATION_ID))
                .thenReturn(noDeltaResponse.getResponse());
        Mockito.when(applicationService.findAppById(APP_ID)).thenReturn(applicationDto);
    ...
    public void testLongSyncTopicNotificationOnStart() throws Exception {
        ...
        Mockito.when(operationsService.updateSyncResponse(noDeltaResponseWithTopicState.getResponse(), Collections.singletonList(topicNotification), null))
                .thenReturn(noDeltaResponseWithTopicState.getResponse());
    ...
    public void testLongSyncTopicNotification() throws Exception {
        ...
        Mockito.when(applicationService.findAppById(APP_ID)).thenReturn(applicationDto);
        Mockito.when(notificationDeltaService.findNotificationById(UNICAST_NOTIFICATION_ID)).thenReturn(topicNotification);
        Mockito.when(operationsService.sync(Mockito.any(SyncRequest.class), Mockito.any(EndpointProfileDto.class))).thenReturn(noDeltaResponseWithTopicState);
        Mockito.when(operationsService.updateSyncResponse(noDeltaResponseWithTopicState.getResponse(), Collections.singletonList(topicNotification), null))
                .thenReturn(noDeltaResponseWithTopicState.getResponse());
    ...
    public void testEndpointEventBasic() throws Exception {
        ...
        SessionInitRequest sourceMessage = toSignedRequest(UUID.randomUUID(), ChannelType.HTTP_LP, channelContextMock, sourceRequest, responseBuilder,
                errorBuilder, sourceCrypt);
        akkaService.process(sourceMessage);

        // sourceRequest
        Mockito.verify(operationsService, Mockito.timeout(TIMEOUT).atLeastOnce()).sync(Mockito.any(SyncRequest.class), Mockito.any(EndpointProfileDto.class));
        ...
        SessionInitRequest targetMessage = toSignedRequest(UUID.randomUUID(), ChannelType.HTTP_LP, channelContextMock, targetRequest, responseBuilder,
                errorBuilder, targetCrypt);
    ...
    public void testLogSyncRequest() throws Exception {
        ...
        LogSyncRequest logRequest = new LogSyncRequest("logUploadRequest1", Collections.singletonList(new LogEntry(ByteBuffer.wrap("String".getBytes()))));
    ...
    public void testUserChange() throws Exception {
        ...
        SessionInitRequest message = toSignedRequest(UUID.randomUUID(), ChannelType.HTTP_LP, channelContextMock, targetRequest, responseBuilder, errorBuilder,
                targetCrypt);
        ...
        Mockito.verify(eventService, Mockito.timeout(TIMEOUT).atLeastOnce()).sendRouteInfo(RouteInfo.deleteRouteFromAddress(TENANT_ID, USER_ID, localAddress),
                SERVER2);
    }
    ...
    public void testEndpointAttach() throws Exception {
        ...
        userSyncResponse.setEndpointAttachResponses(Collections.singletonList(new EndpointAttachResponse("request1", Base64Util.encode(targetPublicKeyHash
                .array()), SyncResponseResultType.SUCCESS)));
        ...
        SessionInitRequest sourceMessage = toSignedRequest(UUID.randomUUID(), ChannelType.HTTP_LP, channelContextMock, sourceRequest, sourceResponseBuilder,
                sourceErrorBuilder);
        akkaService.process(sourceMessage);
        ...
        targetSyncResponse.getUserSyncResponse().setUserAttachNotification(new UserAttachNotification(USER_ID, Base64Util.encode(clientPublicKeyHash.array())));
    ...
    public void testEndpointDetach() throws Exception {
        ...
        SessionInitRequest targetMessage = toSignedRequest(UUID.randomUUID(), ChannelType.HTTP_LP, channelContextMock, targetRequest, targetResponseBuilder,
                targetErrorBuilder, targetCrypt);
        akkaService.process(targetMessage);
