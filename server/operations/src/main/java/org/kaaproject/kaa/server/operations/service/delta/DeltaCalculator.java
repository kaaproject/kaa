...
public interface DeltaCalculator {
     ...
     *
     * @param oldConfiguration old configuration data (json)
     * @param newConfigurationBody the new configuration body (json)
     * @return the raw binary delta
     * @throws IOException Signals that an I/O exception has occurred.
     * @throws DeltaCalculatorException the delta calculator exception
     */
    RawBinaryDelta calculate(String oldConfiguration, String newConfigurationBody)
     ...
     * @throws DeltaCalculatorException the delta calculator exception
     */
    RawBinaryDelta calculate(String newConfigurationBody) throws IOException, DeltaCalculatorException;
     ...
     * @throws DeltaCalculatorException the delta calculator exception
     */
    RawBinaryDelta calculate(byte [] endpointConfiguration, byte [] newConfigurationBody)
            throws IOException, DeltaCalculatorException;
     ...
     * @throws DeltaCalculatorException the delta calculator exception
     */
    RawBinaryDelta calculate(byte [] newConfigurationBody) throws IOException, DeltaCalculatorException;
}
