...
public class SessionHistory implements Track{
    ...
    public class RequestHistory {
         ...
         */
        public RequestHistory(RequestType type) {
     ...
     */
    public RequestHistory newRequest(RequestType type) {
        RequestHistory r = new RequestHistory(type);
        requests.add(r);
        return r;
    }
    ...
    /*
     * (non-Javadoc)
     * @see org.kaaproject.kaa.server.common.http.server.Track#newRequest(java.lang.String)
     */
    @Override
    public int newRequest(String requestName) {
        RequestHistory r = newRequest(typeFromString(requestName));
        return r.getId();
    }
