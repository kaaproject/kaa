...
public class StringApplicationProfileRoute implements ApplicationProfileRoute {

    private final String strRoute;

    public StringApplicationProfileRoute(String strRoute) {
        super();
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        StringApplicationProfileRoute other = (StringApplicationProfileRoute) obj;
        if (strRoute == null) {
    ...
    public String toString() {
        return "StringApplicationProfileRoute [strRoute=" + strRoute + "]";
    }
