...
public class ThriftEndpointDeregistrationMessage implements org.apache.thrift.TBase<ThriftEndpointDeregistrationMessage, ThriftEndpointDeregistrationMessage._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftEndpointDeregistrationMessage> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ThriftEndpointDeregistrationMessage");
  ...
  static {
    schemes.put(StandardScheme.class, new ThriftEndpointDeregistrationMessageStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ThriftEndpointDeregistrationMessageTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ThriftEndpointDeregistrationMessage.class, metaDataMap);
  }

  public ThriftEndpointDeregistrationMessage() {
  }
   ...
   */
  public ThriftEndpointDeregistrationMessage(ThriftEndpointDeregistrationMessage other) {
  ...
  public ThriftEndpointDeregistrationMessage deepCopy() {
    return new ThriftEndpointDeregistrationMessage(this);
  }
  ...
  public ThriftEndpointDeregistrationMessage setAddress(ThriftEntityAddress address) {
    this.address = address;
    return this;
  }
   ...
   * @see ThriftActorClassifier
   */
  public ThriftEndpointDeregistrationMessage setActorClassifier(ThriftActorClassifier actorClassifier) {
    this.actorClassifier = actorClassifier;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ThriftEndpointDeregistrationMessage)
      return this.equals((ThriftEndpointDeregistrationMessage)that);
    return false;
  }

  public boolean equals(ThriftEndpointDeregistrationMessage that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ThriftEndpointDeregistrationMessage other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ThriftEndpointDeregistrationMessage(");
    boolean first = true;
  ...
  private static class ThriftEndpointDeregistrationMessageStandardSchemeFactory implements SchemeFactory {
    public ThriftEndpointDeregistrationMessageStandardScheme getScheme() {
      return new ThriftEndpointDeregistrationMessageStandardScheme();
    }
  }

  private static class ThriftEndpointDeregistrationMessageStandardScheme extends StandardScheme<ThriftEndpointDeregistrationMessage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ThriftEndpointDeregistrationMessage struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftEndpointDeregistrationMessage struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ThriftEndpointDeregistrationMessageTupleSchemeFactory implements SchemeFactory {
    public ThriftEndpointDeregistrationMessageTupleScheme getScheme() {
      return new ThriftEndpointDeregistrationMessageTupleScheme();
    }
  }

  private static class ThriftEndpointDeregistrationMessageTupleScheme extends TupleScheme<ThriftEndpointDeregistrationMessage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ThriftEndpointDeregistrationMessage struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ThriftEndpointDeregistrationMessage struct) throws org.apache.thrift.TException {
