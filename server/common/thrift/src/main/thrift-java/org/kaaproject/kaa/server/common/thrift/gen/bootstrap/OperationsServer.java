...
public class OperationsServer implements org.apache.thrift.TBase<OperationsServer, OperationsServer._Fields>, java.io.Serializable, Cloneable, Comparable<OperationsServer> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("OperationsServer");
  ...
  static {
    schemes.put(StandardScheme.class, new OperationsServerStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OperationsServerTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(OperationsServer.class, metaDataMap);
  }
   ...
   */
  public OperationsServer(OperationsServer other) {
  ...
  public OperationsServer deepCopy() {
    return new OperationsServer(this);
  }
  ...
  public OperationsServer setPriority(int priority) {
    this.priority = priority;
    setPriorityIsSet(true);
    return this;
  }
  ...
  public OperationsServer setPublicKey(byte[] publicKey) {
    setPublicKey(publicKey == null ? (ByteBuffer)null : ByteBuffer.wrap(publicKey));
    return this;
  }

  public OperationsServer setPublicKey(ByteBuffer publicKey) {
    this.publicKey = publicKey;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof OperationsServer)
      return this.equals((OperationsServer)that);
    return false;
  }

  public boolean equals(OperationsServer that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(OperationsServer other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("OperationsServer(");
    boolean first = true;
  ...
  private static class OperationsServerStandardSchemeFactory implements SchemeFactory {
    public OperationsServerStandardScheme getScheme() {
      return new OperationsServerStandardScheme();
    }
  }

  private static class OperationsServerStandardScheme extends StandardScheme<OperationsServer> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, OperationsServer struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OperationsServer struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class OperationsServerTupleSchemeFactory implements SchemeFactory {
    public OperationsServerTupleScheme getScheme() {
      return new OperationsServerTupleScheme();
    }
  }

  private static class OperationsServerTupleScheme extends TupleScheme<OperationsServer> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, OperationsServer struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, OperationsServer struct) throws org.apache.thrift.TException {
