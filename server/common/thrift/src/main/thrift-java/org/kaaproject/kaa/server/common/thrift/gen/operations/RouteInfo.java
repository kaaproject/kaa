...
public class RouteInfo implements org.apache.thrift.TBase<RouteInfo, RouteInfo._Fields>, java.io.Serializable, Cloneable, Comparable<RouteInfo> {
  ...
  public RouteInfo setEndpointId(byte[] endpointId) {
    setEndpointId(endpointId == null ? (ByteBuffer)null : ByteBuffer.wrap(endpointId));
    return this;
  }
  ...
  public int hashCode() {
    ...
    builder.append(present_eventClassFamilyVersion);
    if (present_eventClassFamilyVersion)
      builder.append(eventClassFamilyVersion);
      ...
      if (incoming.get(1)) {
        {
          ...
          {
            EventClassFamilyVersion _elem7;
            _elem7 = new EventClassFamilyVersion();
            _elem7.read(iprot);
            struct.eventClassFamilyVersion.add(_elem7);
          }
        }
        struct.setEventClassFamilyVersionIsSet(true);
      }
