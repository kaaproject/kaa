...
;
  ...
  public EndpointEvent setSender(byte[] sender) {
    setSender(sender == null ? (ByteBuffer)null : ByteBuffer.wrap(sender));
    return this;
  }
  ...
  public EndpointEvent setEventData(byte[] eventData) {
    setEventData(eventData == null ? (ByteBuffer)null : ByteBuffer.wrap(eventData));
    return this;
  }
  ...
  public int hashCode() {
    ...
    builder.append(present_eventData);
