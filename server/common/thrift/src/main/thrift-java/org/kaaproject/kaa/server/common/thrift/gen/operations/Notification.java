...
public class Notification implements org.apache.thrift.TBase<Notification, Notification._Fields>, java.io.Serializable, Cloneable, Comparable<Notification> {
  ...
  private static final org.apache.thrift.protocol.TField UNICAST_NOTIFICATION_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("unicastNotificationId", org.apache.thrift.protocol.TType.STRING, (short)10);
  ...
  public String unicastNotificationId; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    UNICAST_NOTIFICATION_ID((short)10, "unicastNotificationId"),
    TOPIC_ID((short)11, "topicId"),
    KEY_HASH((short)12, "keyHash"),
    /**
     * 
     * @see Operation
     */
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 10: // UNICAST_NOTIFICATION_ID
          return UNICAST_NOTIFICATION_ID;
        case 11: // TOPIC_ID
          return TOPIC_ID;
        case 12: // KEY_HASH
          return KEY_HASH;
  ...
  static {
    ...
    tmpMap.put(_Fields.NOTIFICATION_ID, new org.apache.thrift.meta_data.FieldMetaData("notificationId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , "id")));
    tmpMap.put(_Fields.UNICAST_NOTIFICATION_ID, new org.apache.thrift.meta_data.FieldMetaData("unicastNotificationId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , "id")));
    tmpMap.put(_Fields.TOPIC_ID, new org.apache.thrift.meta_data.FieldMetaData("topicId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , "id")));
    tmpMap.put(_Fields.KEY_HASH, new org.apache.thrift.meta_data.FieldMetaData("keyHash", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    String userVerifierToken)
  {
    ...
    this.keyHash = org.apache.thrift.TBaseHelper.copyBinary(keyHash);
    this.op = op;
  ...
  public Notification(Notification other) {
    ...
    if (other.isSetUnicastNotificationId()) {
      this.unicastNotificationId = other.unicastNotificationId;
    }
  ...
  public void clear() {
    ...
    this.unicastNotificationId = null;
    this.topicId = null;
    this.keyHash = null;
    this.op = null;
  ...
  public String getUnicastNotificationId() {
    return this.unicastNotificationId;
  }

  public Notification setUnicastNotificationId(String unicastNotificationId) {
    this.unicastNotificationId = unicastNotificationId;
    return this;
  }

  public void unsetUnicastNotificationId() {
    this.unicastNotificationId = null;
  }

  /** Returns true if field unicastNotificationId is set (has been assigned a value) and false otherwise */
  public boolean isSetUnicastNotificationId() {
    return this.unicastNotificationId != null;
  }

  public void setUnicastNotificationIdIsSet(boolean value) {
    if (!value) {
      this.unicastNotificationId = null;
    }
  }
  ...
  public ByteBuffer bufferForKeyHash() {
    return org.apache.thrift.TBaseHelper.copyBinary(keyHash);
  }

  public Notification setKeyHash(byte[] keyHash) {
    this.keyHash = keyHash == null ? (ByteBuffer)null : ByteBuffer.wrap(Arrays.copyOf(keyHash, keyHash.length));
    return this;
  }

  public Notification setKeyHash(ByteBuffer keyHash) {
    this.keyHash = org.apache.thrift.TBaseHelper.copyBinary(keyHash);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case UNICAST_NOTIFICATION_ID:
      if (value == null) {
        unsetUnicastNotificationId();
      } else {
        setUnicastNotificationId((String)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case APP_SEQ_NUMBER:
      return getAppSeqNumber();

    case GROUP_ID:
      return getGroupId();

    case GROUP_SEQ_NUMBER:
      return getGroupSeqNumber();

    case PROFILE_FILTER_ID:
      return getProfileFilterId();

    case PROFILE_FILTER_SEQ_NUMBER:
      return getProfileFilterSeqNumber();

    case CONFIGURATION_ID:
      return getConfigurationId();

    case CONFIGURATION_SEQ_NUMBER:
      return getConfigurationSeqNumber();

    case NOTIFICATION_ID:
      return getNotificationId();

    case UNICAST_NOTIFICATION_ID:
      return getUnicastNotificationId();
  ...
  public boolean isSet(_Fields field) {
    ...
    case UNICAST_NOTIFICATION_ID:
      return isSetUnicastNotificationId();
    case TOPIC_ID:
      return isSetTopicId();
    case KEY_HASH:
      return isSetKeyHash();
  ...
  public boolean equals(Notification that) {
    ...
    boolean this_present_unicastNotificationId = true && this.isSetUnicastNotificationId();
    boolean that_present_unicastNotificationId = true && that.isSetUnicastNotificationId();
    if (this_present_unicastNotificationId || that_present_unicastNotificationId) {
      if (!(this_present_unicastNotificationId && that_present_unicastNotificationId))
        return false;
      if (!this.unicastNotificationId.equals(that.unicastNotificationId))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_unicastNotificationId = true && (isSetUnicastNotificationId());
    list.add(present_unicastNotificationId);
    if (present_unicastNotificationId)
      list.add(unicastNotificationId);
  ...
  public int compareTo(Notification other) {
    ...
    lastComparison = Boolean.valueOf(isSetUnicastNotificationId()).compareTo(other.isSetUnicastNotificationId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUnicastNotificationId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.unicastNotificationId, other.unicastNotificationId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("unicastNotificationId:");
    if (this.unicastNotificationId == null) {
      sb.append("null");
    } else {
      sb.append(this.unicastNotificationId);
    }
    first = false;
    if (!first) sb.append(", ");
    sb.append("topicId:");
  ...
  private static class NotificationStandardScheme extends StandardScheme<Notification> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Notification struct) throws org.apache.thrift.TException {
      ...
      if (struct.unicastNotificationId != null) {
        oprot.writeFieldBegin(UNICAST_NOTIFICATION_ID_FIELD_DESC);
        oprot.writeString(struct.unicastNotificationId);
        oprot.writeFieldEnd();
      }
      ...
      if (struct.keyHash != null) {
        oprot.writeFieldBegin(KEY_HASH_FIELD_DESC);
  ...
  private static class NotificationTupleScheme extends TupleScheme<Notification> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, Notification struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetUnicastNotificationId()) {
        optionals.set(9);
      }
