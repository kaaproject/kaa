...
@Repository
public class EndpointSpecificConfigurationMongoDao extends AbstractVersionableMongoDao<MongoEndpointSpecificConfiguration, String> implements EndpointSpecificConfigurationDao<MongoEndpointSpecificConfiguration> {
