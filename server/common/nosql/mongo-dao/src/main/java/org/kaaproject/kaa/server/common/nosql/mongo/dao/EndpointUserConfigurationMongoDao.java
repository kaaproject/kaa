...
@Repository
public class EndpointUserConfigurationMongoDao
    extends AbstractMongoDao<MongoEndpointUserConfiguration, String>
    implements EndpointUserConfigurationDao<MongoEndpointUserConfiguration> {

  private static final Logger LOG =
      LoggerFactory.getLogger(EndpointUserConfigurationMongoDao.class);
  ...
  public MongoEndpointUserConfiguration save(EndpointUserConfigurationDto dto) {
    ...
    MongoEndpointUserConfiguration userConfiguration = save(
        new MongoEndpointUserConfiguration(dto));
  ...
  public List<MongoEndpointUserConfiguration> findByUserId(String userId) {
    ...
    List<MongoEndpointUserConfiguration> configurationList = find(
        query(where(USER_CONF_USER_ID).is(userId)));
