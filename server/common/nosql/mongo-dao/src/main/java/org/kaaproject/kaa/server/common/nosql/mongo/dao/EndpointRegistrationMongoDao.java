 ...
 */
@Repository
public class EndpointRegistrationMongoDao
    extends AbstractMongoDao<MongoEndpointRegistration, String>
    implements EndpointRegistrationDao<MongoEndpointRegistration> {
