...
public class EndpointProfileMongoDao
    extends AbstractVersionableMongoDao<MongoEndpointProfile, ByteBuffer>
    implements EndpointProfileDao<MongoEndpointProfile> {
  ...
  public EndpointProfilesBodyDto findBodyByEndpointGroupId(PageLinkDto pageLink) {
    ...
    for (EndpointProfileDto ep : endpointProfileDtoList) {
      EndpointProfileBodyDto endpointProfileBodyDto = new EndpointProfileBodyDto(
          ep.getEndpointKeyHash(),
          ep.getClientProfileBody(),
          ep.getServerProfileBody(),
          ep.getClientProfileVersion(),
          ep.getServerProfileVersion(),
          ep.getApplicationId());
