...
public final class CassandraEndpointProfile implements EndpointProfile, Serializable {
    ...
    @Column(name = EP_SERVER_PROFILE_ID_PROPERTY)
    ...
    public CassandraEndpointProfile(EndpointProfileDto dto) {
        ...
        this.serverProfileSchemaId = dto.getServerProfileServiceId();
    ...
    public boolean equals(Object o) {
        ...
        if (serverProfileSchemaId != null ? !serverProfileSchemaId.equals(that.serverProfileSchemaId) : that.serverProfileSchemaId != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (serverProfileSchemaId != null ? serverProfileSchemaId.hashCode() : 0);
    ...
    public EndpointProfileDto toDto() {
        ...
        dto.setServerProfileServiceId(serverProfileSchemaId);
        return dto;
    }
}
