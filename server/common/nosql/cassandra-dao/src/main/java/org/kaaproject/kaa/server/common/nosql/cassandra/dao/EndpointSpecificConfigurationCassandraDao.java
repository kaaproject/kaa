...
@Repository
public class EndpointSpecificConfigurationCassandraDao extends AbstractVersionableCassandraDao<CassandraEndpointSpecificConfiguration, String> implements EndpointSpecificConfigurationDao<CassandraEndpointSpecificConfiguration> {
