...
public class CassandraEndpointSpecificConfigurationTest {

  @Test
  public void hashCodeEqualsTest() {
    EqualsVerifier.forClass(CassandraEndpointSpecificConfiguration.class).suppress(Warning.NONFINAL_FIELDS).verify();
  }
