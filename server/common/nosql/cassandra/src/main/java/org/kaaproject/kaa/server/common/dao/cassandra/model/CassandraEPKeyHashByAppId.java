...
import static org.kaaproject.kaa.server.common.dao.cassandra.model.CassandraModelConstants.EP_KEY_HASH_BY_APP_ENDPOINT_KEY_HASH_PROPERTY;

@Table(name = EP_KEY_HASH_BY_APP_COLUMN_FAMILY_NAME)
public class CassandraEPKeyHashByAppId implements Serializable {
    ...
    @PartitionKey
    @Column(name = EP_KEY_HASH_BY_APP_APPLICATION_ID_PROPERTY)
    private String appId;
    @ClusteringColumn
    @Column(name = EP_KEY_HASH_BY_APP_ENDPOINT_KEY_HASH_PROPERTY)
