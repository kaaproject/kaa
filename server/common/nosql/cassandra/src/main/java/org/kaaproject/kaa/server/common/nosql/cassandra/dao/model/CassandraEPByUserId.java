...
@Table(name = CassandraModelConstants.EP_BY_USER_ID_COLUMN_FAMILY_NAME)
public class CassandraEPByUserId implements Serializable {
    ...
    @PartitionKey
    @Column(name = CassandraModelConstants.EP_BY_USER_ID_USER_ID_PROPERTY)
    private String userId;
    @ClusteringColumn
    @Column(name = CassandraModelConstants.EP_BY_USER_ID_ENDPOINT_KEY_HASH_PROPERTY)
