...
import static org.kaaproject.kaa.server.common.dao.cassandra.CassandraDaoUtil.parseId;
import static org.kaaproject.kaa.server.common.dao.cassandra.model.CassandraModelConstants.ET_NF_APPLICATION_ID_PROPERTY;
import static org.kaaproject.kaa.server.common.dao.cassandra.model.CassandraModelConstants.ET_NF_BODY_PROPERTY;
...
import static org.kaaproject.kaa.server.common.dao.cassandra.model.CassandraModelConstants.ET_NF_EXPIRED_AT_PROPERTY;
import static org.kaaproject.kaa.server.common.dao.cassandra.model.CassandraModelConstants.ET_NF_ID_PROPERTY;
import static org.kaaproject.kaa.server.common.dao.cassandra.model.CassandraModelConstants.ET_NF_LAST_MOD_TIME_PROPERTY;
import static org.kaaproject.kaa.server.common.dao.cassandra.model.CassandraModelConstants.ET_NF_NOTIFICATION_TYPE_PROPERTY;
import static org.kaaproject.kaa.server.common.dao.cassandra.model.CassandraModelConstants.ET_NF_SCHEMA_ID_PROPERTY;
import static org.kaaproject.kaa.server.common.dao.cassandra.model.CassandraModelConstants.ET_NF_SEQ_NUM_PROPERTY;
import static org.kaaproject.kaa.server.common.dao.cassandra.model.CassandraModelConstants.ET_NF_TOPIC_ID_PROPERTY;
import static org.kaaproject.kaa.server.common.dao.cassandra.model.CassandraModelConstants.ET_NF_VERSION_PROPERTY;
...
public final class CassandraEndpointNotification implements EndpointNotification, Serializable {
    ...
    @PartitionKey
    @Column(name = ET_NF_ENDPOINT_KEY_HASH_PROPERTY)
    private ByteBuffer endpointKeyHash;
    @ClusteringColumn
    @Column(name = ET_NF_SEQ_NUM_PROPERTY)
    private Integer seqNum;
    @Column(name = ET_NF_ID_PROPERTY)
    private String id;
    @Column(name = ET_NF_NOTIFICATION_TYPE_PROPERTY)
    @Enumerated(EnumType.STRING)
    private NotificationTypeDto type;
    @Column(name = ET_NF_APPLICATION_ID_PROPERTY)
    private String applicationId;
    @Column(name = ET_NF_SCHEMA_ID_PROPERTY)
    private String schemaId;
    @Column(name = ET_NF_VERSION_PROPERTY)
    private int version;
    @Column(name = ET_NF_LAST_MOD_TIME_PROPERTY)
    private Date lastModifyTime;
    @Column(name = ET_NF_BODY_PROPERTY)
    private ByteBuffer body;
    @Column(name = ET_NF_EXPIRED_AT_PROPERTY)
    private Date expiredAt;
    @Column(name = ET_NF_TOPIC_ID_PROPERTY)
    ...
    public String generateId() {
        ...
        if (endpointKeyHash != null) {
            ...
            builder.append(KEY_DELIMITER).append(seqNum);
            id = builder.toString();
        }
        return id;
    }
