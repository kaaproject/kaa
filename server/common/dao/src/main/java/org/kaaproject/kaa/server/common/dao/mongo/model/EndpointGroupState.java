...
public class EndpointGroupState implements ToDto<EndpointGroupStateDto>, Serializable {
    ...
    public EndpointGroupState(ObjectId endpointGroupId, ObjectId profileFilterId, ObjectId configurationId) {
    ...
    public EndpointGroupStateDto toDto() {
        ...
        groupStateDto.setEndpointGroupId(idToString(endpointGroupId));
        groupStateDto.setProfileFilterId(idToString(profileFilterId));
        groupStateDto.setConfigurationId(idToString(configurationId));
