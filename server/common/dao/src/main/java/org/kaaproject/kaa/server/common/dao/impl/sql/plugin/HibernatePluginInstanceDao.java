...
@Repository
public class HibernatePluginInstanceDao extends HibernateAbstractDao<PluginInstance> implements PluginInstanceDao<PluginInstance> {

    private static final Logger LOG = LoggerFactory.getLogger(HibernatePluginInstanceDao.class);

    @Override
    protected Class<PluginInstance> getEntityClass() {
