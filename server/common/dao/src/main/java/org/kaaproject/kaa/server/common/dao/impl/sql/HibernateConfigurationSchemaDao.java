...
@Repository
public class HibernateConfigurationSchemaDao extends HibernateAbstractDao<ConfigurationSchema>
    implements ConfigurationSchemaDao<ConfigurationSchema> {
  ...
  public ConfigurationSchema findByAppIdAndVersion(String appId, int version) {
    ...
    LOG.debug("Searching configuration schema by application id [{}] and version [{}]",
        appId, version);
    if (isNotBlank(appId)) {
