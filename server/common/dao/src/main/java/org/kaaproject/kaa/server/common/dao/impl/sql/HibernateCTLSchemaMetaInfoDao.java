...
public class HibernateCTLSchemaMetaInfoDao extends HibernateAbstractDao<CTLSchemaMetaInfo> implements CTLSchemaMetaInfoDao<CTLSchemaMetaInfo> {
  ...
  public CTLSchemaMetaInfo save(CTLSchemaMetaInfo object) {
    ...
    String applicationId = object.getApplication() != null ? object.getApplication().getStringId() : null;
    LOG.debug("Try to save or find meta info with fqn [{}], tenantId [{}] and applicationId [{}]", object.getFqn(),
        tenantId, applicationId);
    CTLSchemaMetaInfo uniqueMetaInfo = findByFqnTenantIdAndApplicationId(object.getFqn(), tenantId, applicationId);
