...
public class EcfSchemaViewImpl extends BaseListViewImpl<EventClassDto>{
...
//        BaseDetailsViewImpl implements EcfSchemaView, ValueChangeHandler<RecordField> {
//
