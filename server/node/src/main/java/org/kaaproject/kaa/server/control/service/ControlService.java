...
public interface ControlService {
     ...
     */
    EndpointSpecificConfigurationDto createEndpointSpecificConfiguration(EndpointSpecificConfigurationDto configuration);

    /**
     * Updates endpoint specific configuration.
     *
     * @param configuration endpoint specific configuration
     * @return updated endpoint specific configuration
     */
    EndpointSpecificConfigurationDto updateEndpointSpecificConfiguration(EndpointSpecificConfigurationDto configuration);
