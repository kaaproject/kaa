...
/**
 * The Class ConfigurationIdKey is used to model unique key for configuration id lookup (from
 * cache/db). UK consist of applicationToken, applicationSeqNumber, configuration schema version and
 * endpoint group. Indeed, only one configuration can be active for particular application, endpoint
 * group and version in a single period of time (applicationSeqNumber)
 *
 * @author ashvayka
 */
