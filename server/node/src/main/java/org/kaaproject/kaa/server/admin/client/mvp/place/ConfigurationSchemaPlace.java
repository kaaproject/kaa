...
public class ConfigurationSchemaPlace extends AbstractSchemaPlace {
    ...
    public static class Tokenizer extends AbstractSchemaPlace.Tokenizer<ConfigurationSchemaPlace> {
