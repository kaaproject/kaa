...
public class DefaultControlService implements ControlService {
    ...
    @Override
    public EndpointSpecificConfigurationDto createEndpointSpecificConfiguration(EndpointSpecificConfigurationDto configuration) {
        String endpointKeyHash = configuration.getEndpointKeyHash();
        Optional<EndpointSpecificConfigurationDto> existingConfiguration = endpointSpecificConfigurationService.findByEndpointKeyHash(endpointKeyHash);
        if (existingConfiguration.isPresent()) {
            throw new IncorrectParameterException("Endpoint specific configuration already exists.");
        }
    ...
    @Override
    public EndpointSpecificConfigurationDto updateEndpointSpecificConfiguration(EndpointSpecificConfigurationDto configuration) {
        String endpointKeyHash = configuration.getEndpointKeyHash();
        endpointSpecificConfigurationService.findByEndpointKeyHash(endpointKeyHash)
