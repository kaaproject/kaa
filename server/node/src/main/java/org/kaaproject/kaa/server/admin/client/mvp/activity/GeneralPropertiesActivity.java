...
public class GeneralPropertiesActivity
        extends
        AbstractPropertiesActivity<GeneralPropertiesPlace> {

    public GeneralPropertiesActivity(GeneralPropertiesPlace place,
    ...
    protected BasePropertiesView getView(boolean create) {
        return clientFactory.getGeneralPropertiesView();
    }

    @Override
    protected void getEntity(String id, AsyncCallback<PropertiesDto> callback) {
        KaaAdmin.getDataSource().getGeneralProperties(callback);
    }

    @Override
    protected void editEntity(PropertiesDto entity,
            AsyncCallback<PropertiesDto> callback) {
        KaaAdmin.getDataSource().editGeneralProperties(entity, callback);
    }
