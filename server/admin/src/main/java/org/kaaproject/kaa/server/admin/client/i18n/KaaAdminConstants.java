 ...
 * 	'C:/Users/ashvayka/Documents/GitHub/kaa/server/admin/src/main/java/org/kaaproject/kaa/server/admin/client/i18n/KaaAdminConstants.properties'.
 */
public interface KaaAdminConstants extends com.google.gwt.i18n.client.ConstantsWithLookup {
  
  /**
   * Translated "Account profile".
   * 
   * @return translated "Account profile"
   */
  ...
  /**
   * Translated "Account role".
   * 
   * @return translated "Account role"
   */
  ...
  /**
   * Translated "Activated by".
   * 
   * @return translated "Activated by"
   */
  ...
  /**
   * Translated "Add event class family schema".
   * 
   * @return translated "Add event class family schema"
   */
  ...
  /**
   * Translated "Add log schema".
   * 
   * @return translated "Add log schema"
   */
  ...
  /**
   * Translated "Event family mapping".
   * 
   * @return translated "Event family mapping"
   */
  ...
  /**
   * Translated "Event family mapping details".
   * 
   * @return translated "Event family mapping details"
   */
  ...
  /**
   * Translated "Event family mappings".
   * 
   * @return translated "Event family mappings"
   */
  ...
  /**
   * Translated "Application token".
   * 
   * @return translated "Application token"
   */
  ...
  /**
   * Translated "Password strength is insufficient".
   * 
   * @return translated "Password strength is insufficient"
   */
  @DefaultStringValue("Password strength is insufficient")
  @Key("badPasswordStrength")
  String badPasswordStrength();
  ...
  /**
   * Translated "Class type".
   * 
   * @return translated "Class type"
   */
  ...
  /**
   * Translated "Configuration body".
   * 
   * @return translated "Configuration body"
   */
  @DefaultStringValue("Configuration body")
  @Key("configurationBody")
  String configurationBody();

  /**
   * Translated "Configuration details".
   * 
   * @return translated "Configuration details"
   */
  ...
  /**
   * Translated "Configuration schema".
   * 
   * @return translated "Configuration schema"
   */
  ...
  /**
   * Translated "Configuration schema details".
   * 
   * @return translated "Configuration schema details"
   */
  @DefaultStringValue("Configuration schema details")
  @Key("configurationSchemaDetails")
  String configurationSchemaDetails();

  /**
   * Translated "Configuration schema version".
   * 
   * @return translated "Configuration schema version"
   */
  @DefaultStringValue("Configuration schema version")
  @Key("configurationSchemaVersion")
  String configurationSchemaVersion();

  /**
   * Translated "Configuration schemas".
   * 
   * @return translated "Configuration schemas"
   */
  @DefaultStringValue("Configuration schemas")
  @Key("configurationSchemas")
  String configurationSchemas();

  /**
   * Translated "Configurations".
   * 
   * @return translated "Configurations"
   */
  ...
  /**
   * Translated "Confirm delivery".
   * 
   * @return translated "Confirm delivery"
   */
  ...
  /**
   * Translated "Date/Time activated".
   * 
   * @return translated "Date/Time activated"
   */
  @DefaultStringValue("Date/Time activated")
  @Key("dateTimeActivated")
  String dateTimeActivated();

  /**
   * Translated "Date/Time created".
   * 
   * @return translated "Date/Time created"
   */
  ...
  /**
   * Translated "Date/Time deactivated".
   * 
   * @return translated "Date/Time deactivated"
   */
  @DefaultStringValue("Date/Time deactivated")
  @Key("dateTimeDectivated")
  String dateTimeDectivated();

  /**
   * Translated "Date/Time modified".
   * 
   * @return translated "Date/Time modified"
   */
  ...
  /**
   * Translated "Deactivated by".
   * 
   * @return translated "Deactivated by"
   */
  ...
  /**
   * Translated "Default user verifier".
   * 
   * @return translated "Default user verifier"
   */
  @DefaultStringValue("Default user verifier")
  @Key("defaultUserVerifier")
  ...
  /**
   * Translated "Event class family".
   * 
   * @return translated "Event class family"
   */
  ...
  /**
   * Translated "Event class family details".
   * 
   * @return translated "Event class family details"
   */
   ...
   * Translated "ECF name".
   * 
   * @return translated "ECF name"
   */
  @DefaultStringValue("ECF name")
  @Key("ecfName")
  String ecfName();

  /**
   * Translated "Event class family schema".
   * 
   * @return translated "Event class family schema"
   */
  ...
  /**
   * Translated "Event class family schema details".
   * 
   * @return translated "Event class family schema details"
   */
  @DefaultStringValue("Event class family schema details")
  @Key("ecfSchemaDetails")
  String ecfSchemaDetails();

  /**
   * Translated "Event class family version".
   * 
   * @return translated "Event class family version"
   */
  ...
  /**
   * Translated "Event class families".
   * 
   * @return translated "Event class families"
   */
  ...
  /**
   * Translated "Email address is already in use".
   * 
   * @return translated "Email address is already in use"
   */
  @DefaultStringValue("Email address is already in use")
  @Key("emailExists")
  String emailExists();

  /**
   * Translated "Endpoint group".
   * 
   * @return translated "Endpoint group"
   */
  ...
  /**
   * Translated "Endpoint group details".
   * 
   * @return translated "Endpoint group details"
   */
  @DefaultStringValue("Endpoint group details")
  @Key("endpointGroupDetails")
  String endpointGroupDetails();

  /**
   * Translated "Endpoint groups".
   * 
   * @return translated "Endpoint groups"
   */
  ...
  /**
   * Translated "Event class schema".
   * 
   * @return translated "Event class schema"
   */
  @DefaultStringValue("Event class schema")
  @Key("eventClassSchema")
  String eventClassSchema();

  /**
   * Translated "Event classes".
   * 
   * @return translated "Event classes"
   */
  ...
  /**
   * Translated "Event map".
   * 
   * @return translated "Event map"
   */
  ...
  /**
   * Translated "Expires at".
   * 
   * @return translated "Expires at"
   */
  ...
  /**
   * Translated "No file found in post request!".
   * 
   * @return translated "No file found in post request!"
   */
  @DefaultStringValue("No file found in post request!")
  @Key("fileNotFound")
  String fileNotFound();

  /**
   * Translated "Filter body".
   * 
   * @return translated "Filter body"
   */
   ...
   * 
   * @return translated "General settings"
   */
  ...
  /**
   * Translated "General settings details".
   * 
   * @return translated "General settings details"
   */
  @DefaultStringValue("General settings details")
  @Key("generalSettingsDetails")
  String generalSettingsDetails();

  /**
   * Translated "Generate SDK".
   * 
   * @return translated "Generate SDK"
   */
  ...
  /**
   * Translated "Include deprecated".
   * 
   * @return translated "Include deprecated"
   */
  ...
  /**
   * Translated "Incompatible server version".
   * 
   * @return translated "Incompatible server version"
   */
  ...
  /**
   * Translated "Provided arguments are invalid for requested operation!".
   * 
   * @return translated "Provided arguments are invalid for requested operation!"
   */
  ...
  /**
   * Translated "Schema validation error: ".
   * 
   * @return translated "Schema validation error: "
   */
  ...
  /**
   * Translated "Requested item not found!".
   * 
   * @return translated "Requested item not found!"
   */
   ...
   * Translated "Kaa".
   * 
   * @return translated "Kaa"
   */
  @DefaultStringValue("Kaa")
  @Key("kaa")
  String kaa();

  /**
   * Translated "Kaa administrator".
   * 
   * @return translated "Kaa administrator"
   */
  @DefaultStringValue("Kaa administrator")
  @Key("kaaAdmin")
  String kaaAdmin();
  ...
  /**
   * Translated "Log appender".
   * 
   * @return translated "Log appender"
   */
  ...
  /**
   * Translated "Log appender details".
   * 
   * @return translated "Log appender details"
   */
  @DefaultStringValue("Log appender details")
  @Key("logAppenderDetails")
  String logAppenderDetails();

  /**
   * Translated "Log appender status".
   * 
   * @return translated "Log appender status"
   */
  @DefaultStringValue("Log appender status")
  @Key("logAppenderStatus")
  String logAppenderStatus();

  /**
   * Translated "Log appender type".
   * 
   * @return translated "Log appender type"
   */
  ...
  /**
   * Translated "Log appenders".
   * 
   * @return translated "Log appenders"
   */
  ...
  /**
   * Translated "Log in again".
   * 
   * @return translated "Log in again"
   */
  ...
  /**
   * Translated "Log metadata".
   * 
   * @return translated "Log metadata"
   */
  ...
  /**
   * Translated "Log schema".
   * 
   * @return translated "Log schema"
   */
  ...
  /**
   * Translated "Log schema details".
   * 
   * @return translated "Log schema details"
   */
  @DefaultStringValue("Log schema details")
  @Key("logSchemaDetails")
  String logSchemaDetails();

  /**
   * Translated "Log schema version".
   * 
   * @return translated "Log schema version"
   */
  @DefaultStringValue("Log schema version")
  @Key("logSchemaVersion")
  String logSchemaVersion();

  /**
   * Translated "Log schemas".
   * 
   * @return translated "Log schemas"
   */
  ...
  /**
   * Translated "Max schema version".
   * 
   * @return translated "Max schema version"
   */
  ...
  /**
   * Translated "Min schema version".
   * 
   * @return translated "Min schema version"
   */
  ...
  /**
   * Translated "You are not authorized to perform this operation!".
   * 
   * @return translated "You are not authorized to perform this operation!"
   */
  ...
  /**
   * Translated "Notification body".
   * 
   * @return translated "Notification body"
   */
  ...
  /**
   * Translated "Notification details".
   * 
   * @return translated "Notification details"
   */
  ...
  /**
   * Translated "Notification schema".
   * 
   * @return translated "Notification schema"
   */
  ...
  /**
   * Translated "Notification schema details".
   * 
   * @return translated "Notification schema details"
   */
  @DefaultStringValue("Notification schema details")
  @Key("notificationSchemaDetails")
  String notificationSchemaDetails();

  /**
   * Translated "Notification schema version".
   * 
   * @return translated "Notification schema version"
   */
  @DefaultStringValue("Notification schema version")
  @Key("notificationSchemaVersion")
  String notificationSchemaVersion();

  /**
   * Translated "Notification schemas".
   * 
   * @return translated "Notification schemas"
   */
  @DefaultStringValue("Notification schemas")
  @Key("notificationSchemas")
  String notificationSchemas();

  /**
   * Translated "Notification topic".
   * 
   * @return translated "Notification topic"
   */
  ...
  /**
   * Translated "Notification topic details".
   * 
   * @return translated "Notification topic details"
   */
  @DefaultStringValue("Notification topic details")
  @Key("notificationTopicDetails")
  String notificationTopicDetails();

  /**
   * Translated "Notification topics".
   * 
   * @return translated "Notification topics"
   */
  @DefaultStringValue("Notification topics")
  @Key("notificationTopics")
  String notificationTopics();

  /**
   * Translated "Number of endpoints".
   * 
   * @return translated "Number of endpoints"
   */
  @DefaultStringValue("Number of endpoints")
  @Key("numberOfEndpoints")
  String numberOfEndpoints();

  /**
   * Translated "Number of EPs".
   * 
   * @return translated "Number of EPs"
   */
  ...
  /**
   * Translated "Current password is invalid".
   * 
   * @return translated "Current password is invalid"
   */
  @DefaultStringValue("Current password is invalid")
  @Key("oldPasswordMismatch")
  String oldPasswordMismatch();

  /**
   * Translated "Outgoing mail".
   * 
   * @return translated "Outgoing mail"
   */
  ...
  /**
   * Translated "Outgoing mail settings".
   * 
   * @return translated "Outgoing mail settings"
   */
  @DefaultStringValue("Outgoing mail settings")
  @Key("outgoingMailSettings")
  ...
  /**
   * Translated "Password has been reset".
   * 
   * @return translated "Password has been reset"
   */
  ...
  /**
   * Translated "You do not have permission to perform this operation!".
   * 
   * @return translated "You do not have permission to perform this operation!"
   */
  ...
  /**
   * Translated "Profile filter".
   * 
   * @return translated "Profile filter"
   */
  ...
  /**
   * Translated "Profile filter details".
   * 
   * @return translated "Profile filter details"
   */
  @DefaultStringValue("Profile filter details")
  @Key("profileFilterDetails")
  String profileFilterDetails();

  /**
   * Translated "Profile filters".
   * 
   * @return translated "Profile filters"
   */
  ...
  /**
   * Translated "Profile schema".
   * 
   * @return translated "Profile schema"
   */
  ...
  /**
   * Translated "Profile schema details".
   * 
   * @return translated "Profile schema details"
   */
  @DefaultStringValue("Profile schema details")
  @Key("profileSchemaDetails")
  String profileSchemaDetails();

  /**
   * Translated "Profile schema version".
   * 
   * @return translated "Profile schema version"
   */
  ...
  /**
   * Translated "Profile schemas".
   * 
   * @return translated "Profile schemas"
   */
  ...
  /**
   * Translated "Reset link has been sent".
   * 
   * @return translated "Reset link has been sent"
   */
  @DefaultStringValue("Reset link has been sent")
  @Key("resetLinkWasSent")
  String resetLinkWasSent();

  /**
   * Translated "Reset password".
   * 
   * @return translated "Reset password"
   */
  ...
  /**
   * Translated "Schema version".
   * 
   * @return translated "Schema version"
   */
  ...
  /**
   * Translated "SDK details".
   * 
   * @return translated "SDK details"
   */
  ...
  /**
   * Translated "Select notification file".
   * 
   * @return translated "Select notification file"
   */
  @DefaultStringValue("Select notification file")
  @Key("selectNotificationFile")
  String selectNotificationFile();

  /**
   * Translated "Select notification topics".
   * 
   * @return translated "Select notification topics"
   */
  @DefaultStringValue("Select notification topics")
  @Key("selectNotificationTopics")
  String selectNotificationTopics();

  /**
   * Translated "Select schema file".
   * 
   * @return translated "Select schema file"
   */
  @DefaultStringValue("Select schema file")
  @Key("selectSchemaFile")
  ...
  /**
   * Translated "Send notification".
   * 
   * @return translated "Send notification"
   */
  ...
  /**
   * Translated "Send reset password link".
   * 
   * @return translated "Send reset password link"
   */
  ...
  /**
   * Translated "Server is unreachable".
   * 
   * @return translated "Server is unreachable"
   */
  @DefaultStringValue("Server is unreachable")
  @Key("serverIsUnreachable")
  ...
  /**
   * Translated "SMTP mail server details".
   * 
   * @return translated "SMTP mail server details"
   */
  @DefaultStringValue("SMTP mail server details")
  @Key("smtpMailServerDetails")
  ...
  /**
   * Translated "Tenant administrator".
   * 
   * @return translated "Tenant administrator"
   */
  @DefaultStringValue("Tenant administrator")
  @Key("tenantAdmin")
  String tenantAdmin();

  /**
   * Translated "Tenant administrator email".
   * 
   * @return translated "Tenant administrator email"
   */
  @DefaultStringValue("Tenant administrator email")
  @Key("tenantAdminEmail")
  String tenantAdminEmail();

  /**
   * Translated "Tenant administrator username".
   * 
   * @return translated "Tenant administrator username"
   */
  @DefaultStringValue("Tenant administrator username")
  @Key("tenantAdminUsername")
  String tenantAdminUsername();

  /**
   * Translated "Tenant details".
   * 
   * @return translated "Tenant details"
   */
  ...
  /**
   * Translated "Tenant developer".
   * 
   * @return translated "Tenant developer"
   */
  @DefaultStringValue("Tenant developer")
  @Key("tenantDeveloper")
  String tenantDeveloper();

  /**
   * Translated "Tenant name".
   * 
   * @return translated "Tenant name"
   */
  ...
  /**
   * Translated "Tenant user".
   * 
   * @return translated "Tenant user"
   */
  ...
  /**
   * Translated "Upload from file".
   * 
   * @return translated "Upload from file"
   */
  ...
  /**
   * Translated "Requested user doesn't have email".
   * 
   * @return translated "Requested user doesn't have email"
   */
  @DefaultStringValue("Requested user doesn't have email")
  @Key("userEmailNotDefined")
  String userEmailNotDefined();

  /**
   * Translated "There is no registered user with specified email".
   * 
   * @return translated "There is no registered user with specified email"
   */
  ...
  /**
   * Translated "User with given username not found".
   * 
   * @return translated "User with given username not found"
   */
  ...
  /**
   * Translated "There is no registered user with specified username or email".
   * 
   * @return translated "There is no registered user with specified username or email"
   */
  @DefaultStringValue("There is no registered user with specified username or email")
  @Key("userOrEmailNotFound")
  String userOrEmailNotFound();
  ...
  /**
   * Translated "User verifier details".
   * 
   * @return translated "User verifier details"
   */
  @DefaultStringValue("User verifier details")
  @Key("userVerifierDetails")
  String userVerifierDetails();

  /**
   * Translated "User verifiers".
   * 
   * @return translated "User verifiers"
   */
  ...
  /**
   * Translated "Entered user name already in use, please choose another".
   * 
   * @return translated "Entered user name already in use, please choose another"
   */
  @DefaultStringValue("Entered user name already in use, please choose another")
  @Key("usernameExists")
   ...
   * 
   * @return translated "Username or email"
   */
  ...
  /**
   * Translated "Verifier token".
   * 
   * @return translated "Verifier token"
   */
