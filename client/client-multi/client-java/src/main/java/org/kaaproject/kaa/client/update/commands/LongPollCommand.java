...
/**
 * Command for long poll requests.
 *
 * @author Yaroslav Zeygerman
 *
 */
public class LongPollCommand extends AbstractCommand {
    
    /** The Constant logger. */
    private static final Logger LOG = LoggerFactory
            .getLogger(PollCommand.class);

    final LongSyncRequest request;
    final UpdateManager manager;
    final OperationsTransport transport;

    public LongPollCommand(LongSyncRequest request,
    ...
    protected void doExecute() throws TransportException {
        ...
        SyncResponse response = transport.sendLongSyncRequest(request);
