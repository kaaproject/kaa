...
public class DefaultNotificationManagerTest {
    ...
    public void testSubscriptions() throws IOException, UnavailableTopicException {
        KaaClientPropertiesState state = new KaaClientPropertiesState(KaaClientPropertiesStateTest.getProperties());
        UpdateManager updateManager = mock(UpdateManager.class);
        DefaultNotificationManager manager = new DefaultNotificationManager(updateManager, state);
        ...
        verify(updateManager, never()).updateSubscriptionCommands(any(List.class));
