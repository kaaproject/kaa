...
void test_handle_server_sync(void **state)
{
    ...
    test_channel_context_t protocol1_channel_context = { protocol1, NULL, SUPPORTED_SERVICES, SUPPORTED_SERVICES_COUNT, {NULL} };
    ...
    test_channel_context_t protocol2_channel_context = { protocol2, NULL, SUPPORTED_SERVICES, SUPPORTED_SERVICES_COUNT, {NULL} };
    ...
    test_channel_context_t protocol3_channel_context = { protocol3, NULL, SUPPORTED_SERVICES, SUPPORTED_SERVICES_COUNT, {NULL} };
