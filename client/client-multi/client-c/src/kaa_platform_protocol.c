...
//    buffer += KAA_EXTENSION_HEADER_SIZE;
//    buf_size -= buf_size;
//
//    uint8_t byte = KAA_META_DATA_EXTENSION_TYPE;
//    KAA_RETURN_IF_ERR(kaa_platform_message_write(buffer, buf_size, &byte, sizeof(byte)));
