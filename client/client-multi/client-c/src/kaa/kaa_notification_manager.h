...
*
* @param[in]  context      The pointer to the Kaa context.
...
* @return The error code.
*/
kaa_error_t kaa_add_optional_notification_listener(kaa_context_t *context, kaa_notification_listener_t *listener
