...
CFILES-PLAT-IMPL = kaa/platform-impl/common/ext_log_storage_memory.c kaa/platform-impl/common/ext_log_upload_strategies.c kaa/platform-impl/posix/posix_kaa_failover_strategy.c kaa/platform-impl/common/kaa_tcp_channel.c kaa/platform-impl/common/kaa_htonll.c
