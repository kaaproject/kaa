...
#include "ext_log_upload_strategy_by_volume.h"
...
kaa_error_t ext_log_upload_strategy_create(struct kaa_context_s *context, void **strategy_p)
{
    KAA_RETURN_IF_NIL4(strategy_p, context, context->channel_manager, context->bootstrap_manager, KAA_ERR_BADPARAM);
