...
{
    KAA_RETURN_IF_NULL(kaa_context_p, KAA_ERR_BADPARAM);
...
{
    KAA_RETURN_IF_NULL(kaa_context, KAA_ERR_BADPARAM);
...
{
    KAA_RETURN_IF_NULL(kaa_context, KAA_ERR_BADPARAM);
    KAA_RETURN_IF_NULL(kaa_context->status, KAA_ERR_NOT_INITIALIZED);
