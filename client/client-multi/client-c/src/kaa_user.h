...
kaa_error_t kaa_user_attach_to_user(kaa_context_t *, const char *, const char *);
kaa_error_t kaa_set_attachment_callback(kaa_context_t *, user_response_handler_t);

kaa_user_sync_request_t* kaa_user_compile_request(void *ctx, size_t requestId);
kaa_error_t kaa_user_handle_sync(kaa_context_t *, kaa_user_attach_response_t *, kaa_user_attach_notification_t *, kaa_user_detach_notification_t *);
