...
package org.kaaproject.kaa.client.logging.gen;
...
public class SuperRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static org.kaaproject.kaa.client.logging.gen.SuperRecord.Builder newBuilder() {
    return new org.kaaproject.kaa.client.logging.gen.SuperRecord.Builder();
  }
  
  /** Creates a new SuperRecord RecordBuilder by copying an existing Builder */
  public static org.kaaproject.kaa.client.logging.gen.SuperRecord.Builder newBuilder(org.kaaproject.kaa.client.logging.gen.SuperRecord.Builder other) {
    return new org.kaaproject.kaa.client.logging.gen.SuperRecord.Builder(other);
  }
  
  /** Creates a new SuperRecord RecordBuilder by copying an existing SuperRecord instance */
  public static org.kaaproject.kaa.client.logging.gen.SuperRecord.Builder newBuilder(org.kaaproject.kaa.client.logging.gen.SuperRecord other) {
    return new org.kaaproject.kaa.client.logging.gen.SuperRecord.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SuperRecord>
    ...
    private Builder() {
      super(org.kaaproject.kaa.client.logging.gen.SuperRecord.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.kaaproject.kaa.client.logging.gen.SuperRecord.Builder other) {
      super(other);
    ...
    private Builder(org.kaaproject.kaa.client.logging.gen.SuperRecord other) {
            super(org.kaaproject.kaa.client.logging.gen.SuperRecord.SCHEMA$);
      if (isValidValue(fields()[0], other.logdata)) {
        this.logdata = data().deepCopy(fields()[0].schema(), other.logdata);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'logdata' field */
    public org.kaaproject.kaa.client.logging.gen.SuperRecord.Builder setLogdata(java.lang.String value) {
    ...
    public org.kaaproject.kaa.client.logging.gen.SuperRecord.Builder clearLogdata() {
      logdata = null;
