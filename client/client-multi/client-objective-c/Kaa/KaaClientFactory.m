...
+ (id<KaaClient>)clientWithContext:(id<KaaClientPlatformContext>)context stateDelegate:(id<KaaClientStateDelegate>)delegate {
    return [self clientWithContext:context stateDelegate:delegate autoGeneratedKeys:NO];
}
...
+ (id<KaaClient>)clientWithContext:(id<KaaClientPlatformContext>)context {
    return [self clientWithContext:context stateDelegate:nil autoGeneratedKeys:NO];
}

+ (id<KaaClient>)clientWithStateDelegate:(id<KaaClientStateDelegate>)delegate {
    return [self clientWithContext:[[DefaultKaaPlatformContext alloc] init] stateDelegate:delegate autoGeneratedKeys:NO];
}
