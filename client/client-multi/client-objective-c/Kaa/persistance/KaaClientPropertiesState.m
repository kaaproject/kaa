...
- (void)parseTopics;
- (KeyPair *)getOrGenerateKeyPair:(BOOL)isAutogeneratedKeys;
...
- (instancetype)initWithBase64:(id<KAABase64>)base64 clientProperties:(KaaClientProperties *)properties {
    return [self initWithBase64:base64 clientProperties:properties autogeneratedKeys:NO];
}

- (instancetype)initWithBase64:(id<KAABase64>)base64 clientProperties:(KaaClientProperties *)properties autogeneratedKeys:(BOOL)isAutogeneratedKeys {
    self = [super init];
    if (self) {
        self.base64 = base64;
        ...
        self.isAutogeneratedKeys = isAutogeneratedKeys;
...
- (NSData *)publicKeyAsBytes {
    [self getOrGenerateKeyPair:self.isAutogeneratedKeys];
    return [KeyUtils getPublicKey];
}

- (SecKeyRef)publicKey {
    return [[self getOrGenerateKeyPair:self.isAutogeneratedKeys] getPublicKeyRef];
}

- (SecKeyRef)privateKey {
    return [[self getOrGenerateKeyPair:self.isAutogeneratedKeys] getPrivateKeyRef];
}
