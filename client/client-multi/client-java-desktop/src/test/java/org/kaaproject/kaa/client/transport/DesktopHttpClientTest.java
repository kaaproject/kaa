...
public class DesktopHttpClientTest {
    ...
    private static PrivateKey privateKey = mock(PrivateKey.class);
    private static PublicKey publicKey = mock(PublicKey.class);
    private static PublicKey remotePublicKey = mock(PublicKey.class);
