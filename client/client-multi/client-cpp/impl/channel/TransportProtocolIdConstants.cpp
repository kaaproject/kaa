...
const TransportProtocolId TransportProtocolIdConstants::HTTP_TRANSPORT_ID(HTTP_TRANSPORT_PROTOCOL_ID,
                                                                          HTTP_TRANSPORT_PROTOCOL_VERSION);

const TransportProtocolId TransportProtocolIdConstants::TCP_TRANSPORT_ID(TCP_TRANSPORT_PROTOCOL_ID,
                                                                         TCP_TRANSPORT_PROTOCOL_VERSION);
