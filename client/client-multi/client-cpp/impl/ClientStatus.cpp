...
ClientStatus::ClientStatus(const std::string &filename, IKaaClientContext& context) : filename_(filename), isSDKPropertiesForUpdated_(false), hasUpdate_(false), context_(context)
{
