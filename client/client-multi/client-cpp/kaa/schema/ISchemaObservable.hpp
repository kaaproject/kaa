...
/**
 * Interface for managing subscriptions for data schema updates.
 */
...
public:
    ...
    /**
     * Subscribes receiver for data schema updates.
     *
     * @param receiver Data schema updates receiver to be subscribed.
     */
     ...
     *
     * @param receiver Data schema updates receiver to be unsubscribed.
     */
