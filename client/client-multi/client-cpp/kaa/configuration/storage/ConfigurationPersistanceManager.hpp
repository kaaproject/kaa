...
#ifndef CONFIGURATIONPERSISTANCEMANAGER_HPP_
#define CONFIGURATIONPERSISTANCEMANAGER_HPP_
...
/**
 * \class ConfigurationPersistanceManager
 *
 * This class is responsible for persistance of configuration invoking
 ...
 * respectively.
 */
class ConfigurationPersistanceManager : public IConfigurationPersistanceManager {
public:
    ConfigurationPersistanceManager()
        : storage_(NULL)
        , processor_(NULL)
    ...
    /**
     * @link IConfigurationPersistanceManager @endlink implementation
     */
...
private:
    ...
    mutex_type                              confPersistanceGuard_;
...
#endif /* CONFIGURATIONPERSISTANCEMANAGER_HPP_ */
