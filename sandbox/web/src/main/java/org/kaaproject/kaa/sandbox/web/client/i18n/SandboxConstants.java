 ...
 * 	'/home/vii/Projects/Kaa/sandbox/web/src/main/java/org/kaaproject/kaa/sandbox/web/client/i18n/SandboxConstants.properties'.
 */
public interface SandboxConstants extends com.google.gwt.i18n.client.ConstantsWithLookup {
   ...
   */
  @DefaultStringValue("Kaa administrative web console")
  @Key("kaaAdminWeb")
  String kaaAdminWeb();

  /**
   * Translated "Main console".
   * 
   * @return translated "Main console"
   */
