...
public enum KaaPackage {
    ...
    BOOTSTRAP("bootstrap", "kaa-bootstrap", "/etc/kaa-bootstrap/conf/bootstrap-server.properties", new String[] {"transport.publicInterface" }), 
    CONTROL("control", "kaa-control", "/etc/kaa-control/conf/control-server.properties", new String[] {}), 
    OPERATIONS("operations", "kaa-operations", "/etc/kaa-operations/conf/operations-server.properties", new String[] { "transport.publicInterface" }), 
