...
5. Use Admin UI or REST API to create/update/delete your log appender instances as described in [Existing log appender implementations]({{root_url}}Programming-guide/Key-platform-features/Data-collection/#existing-log-appender-implementations).
