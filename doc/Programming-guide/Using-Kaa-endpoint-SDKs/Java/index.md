...
The Kaa Java SDK should be preferred if you want to run your application on different platforms or you are going to develop an Android application.
...
the boolean argument that specifies whether to generate a public/private key pair automatically.
...
As to the third argument: when it is set to **false**, then an existing pre-generated public/private key pair is used; when **true**, then a new public/private key pair is auto-generated when there is none.
