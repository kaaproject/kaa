...
- [Lifecycle](#lifecycle)
- [Samples of applications](#your-first-kaa-application)
  - [Collecting endpoint profiles](#add-application)
  - [Using endpoint groups](#create-notification-schema)
  - [Messaging across endpoints](#generate-sdk)
  - [Using notifications](#sample-client-application)
  - [Collecting data from endpoints](#create-notification-topic)
  - [Distributing data to endpoints](#create-notification)
...
At start you should [generate Endpoint SDK](Getting-started#generate-sdk) for target platform - Java. SDK is a jar file that developer should add to classpath using some build tools.
...
**Current configuration(on hte endpoint)**
```json
{
    "testField1": {
        "string": "abc"
...
![](attach/image2015-2-9 14-35-13.png)
...
| Client-side Endpoint Profile A    | Client-side Endpoint Profile B    | Client-side Endpoint Profile C    |
|:----------------------------------:|:-----------------------------------:|:---------------------------------:|
|
```json
{
...
| Server-side Endpoint Profile A                            | Server-side Endpoint Profile B                            |              Server-side Endpoint Profile C              |
|-----------------------------------------------------------|-----------------------------------------------------------|:--------------------------------------------------------:|
|
```json
{
